...
captcha_html += '<iframe id="doom_captcha" src="https://its-pablo.github.io/99captcha/captcha.html?countdown=' + document.currentScript.getAttribute('countdown') + '&enemies=' + captcha_enemies + '" style="width:300px;height:150px;border:2px black solid;"></iframe>';
if (captcha_label) {
    captcha_html += '</p>';
}
